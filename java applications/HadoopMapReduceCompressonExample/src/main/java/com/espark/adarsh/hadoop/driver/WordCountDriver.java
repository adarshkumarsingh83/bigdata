...
public class WordCountDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        FileOutputFormat.setCompressOutput(mapReduceJob,true);

        // setting up the output compresson type
        FileOutputFormat.setOutputCompressorClass(mapReduceJob, GzipCodec.class);
